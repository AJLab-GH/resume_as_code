...
\small{\textbf{Strategic Sales Support:} Acted as a key technical resource for strategic pre-sales engagements across Canada, collaborating with Fortinet Sales teams to design and recommend tailored security solutions, ensuring optimal customer satisfaction.}

\is
\small{\textbf{Customer and Partner Engagements:} Led high-impact technical meetings, presentations, and product demonstrations for customers and channel partners, highlighting Fortinet's strengths.}

\is
\small{\textbf{Solution Architecture and Design:} Partenered with SE peers to architect secure IP networks, leveraging all facets of Fortinet's product line to deliver superior solutions in competitive scenarios.}

\is
\small{\textbf{Technical Consultancy:} Served as a subject-matter expert in pre-sales design reviews, providing technical guidance to internal stakeholders to drive positive customer outcomes in competitive scenarios.}

\is
\small{\textbf{Training \& Mentorship:} Led nationwide training for System Engineers and mentored SE specialists within Virtual Teams to enhance technical skills.}

\is
\small{\textbf{Cross-functional Collaboration:} Collaborated with Engineering to identify, qualify, and develop key features that strengthen Fortinet’s market position.}

\is
\small{\textbf{Technical Documentation:} Developed comprehensive technical guides to streamline product demonstrations and emphasize Fortinet's advantages.}

\vspace{2ex}
\textsc{Presales Security Expert --- Cloud Architect} at \textit{Fortinet  (Federal).} \dates{2019.06--2022.04}\\

\small{\textbf{Sales Support:} Acted as the primary technical resource on sales calls, educating customers on features, specifications, functionality, and integration of networking solutions.}

\is
\small{\textbf{Federal Sector Selling:} Successfully sold tailored solutions to the Federal vertical, enhancing company presence in the sector.}

\is
\small{\textbf{High-Value Deals:} Closed multiple significant deals, driving substantial revenue growth.}

\is
\small{\textbf{Presentations:} Delivered persuasive presentations to C-suite executives and team members, securing buy-in across all levels of the organization.}

\vspace{2ex}
\textsc{Diamond Services Engineer \& TAC} at \textit{Check Point (North America).} \dates{2017.01--2019.06}\\

\small{\textbf{Customer Engagement:} Played a key role in the design, deployment, and maintenance of cloud security solutions for Fortune 100 companies. Additionally, led training on public and private cloud solutions for both internal stakeholders and customers across Canada, the United States, and internationally.}
